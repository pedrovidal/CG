...
function init() {
	...
	var moonMaterial = createMoonMaterial();
	...
	var marsMaterial = createMarsMaterial();
...
function createMoonMaterial() {
    ...
    var moonTexture    = textureLoader.load("moon_1024.jpg");
...
function createMarsMaterial() {
    ...
    var marsTexture    = textureLoader.load("mars.jpg");
